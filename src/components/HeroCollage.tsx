...
const ITEMS: CollageItem[] = [
  ...
  {
    src: `${SUPABASE_BASE}/f5310764-a9a0-40a0-a34b-daa7461c25da/478f0e36-bf2b-4d72-9173-63a5c38c86ac.png`,
    alt: "Cápsula solidaria real de Alejandra, con un diorama de surf",
    caption: "Alejandra · Donó 1 €",
    detail: "Surf",
  ...
  {
    src: "/capsulas/capsula-camila.webp",
    alt: "Cápsula solidaria real de Camila, con bandera de Venezuela y su perrito",
    caption: "Camila",
    detail: "Arte",
    className: "bottom-[-2%] left-[2%] z-20 w-[40%]",
    rotate: "rotate-3",
    delay: "0.7s",
  },
  {
