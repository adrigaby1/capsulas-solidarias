...
El personaje NUNCA es una fotografía real de una persona en miniatura: es una miniatura estilo chibi de cuerpo completo hasta los pies, con acabado de personaje de animación 3D de calidad premium (nivel de estudio de animación tipo Pixar/DreamWorks) —cabeza algo más grande de lo natural, ojos grandes, expresivos y luminosos, sonrisa cálida—, con un acabado extremadamente detallado en piel, cabello y ropa, sin llegar al muñeco de juguete de plástico duro ni al anime plano. Debe reconocerse con total claridad a la persona de la fotografía adjunta: mismo tono de piel, forma de la cara, color y forma de ojos, peinado y sonrisa. Piel y cabello con textura suave y luminosa de render 3D de gama alta —nunca plana, nunca de plástico, nunca fotografía realista de piel humana—. Cuerpo completo hasta los pies.
...
function buildIntro(data: CapsuleFormData): string {
  ...
  return `Crea un retrato hiperrealista de una cápsula de gashapon 100% de vidrio, sostenida delicadamente entre dos dedos humanos. Dentro de la cápsula, coloca una miniatura estilo chibi de cuerpo completo hasta los pies, con acabado de personaje de animación 3D premium, inspirada en la fotografía adjunta de ${data.nombre}${ocasion}. El rostro del personaje debe recordar claramente a la persona de la foto, pero dibujado con el acabado y las proporciones estilizadas de un personaje de película de animación, nunca como una fotografía realista en miniatura.`;
}
